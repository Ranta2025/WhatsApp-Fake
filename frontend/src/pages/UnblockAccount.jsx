        ...
        <AuthLayout
            ...
            footer={(
                <span className="text-slate-400">
                    ¿Necesitas ayuda? <Link to="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">Volver al login</Link>
                </span>
            )}
        >
            ...
            {step === 2 && (
                <form onSubmit={handleStep2} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-400 mb-1.5">Código de Desbloqueo</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg className="h-5 w-5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        type="submit"
                        className="w-full mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-indigo-500/20 transform transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                    >
                        Verificar código
                    </button>
                    <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="w-full bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold py-3.5 rounded-xl transition-all duration-200"
                    >
                        Volver
                    </button>
                </form>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 p-3.5 pr-12 rounded-xl bg-slate-800 border border-transparent text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors tracking-wide"
                                placeholder="Mínimo 8 caracteres"
                            />
                            <button
                                type="button"
                                onClick={() => setShowPassword((v) => !v)}
                                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-indigo-400 text-sm font-medium transition-colors"
                            >
