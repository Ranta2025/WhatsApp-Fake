        ...
        <AuthLayout
            ...
            footer={(
                <span className="text-slate-400">
                    ¿Recuerdas tu contraseña? <Link to="/login" className="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">Inicia sesión</Link>
                </span>
            )}
        >
            ...
            {step === 2 && (
                <form onSubmit={handleStep2} className="space-y-4">
                    <div>
                        <label className="block text-sm font-medium text-slate-400 mb-1.5">Código de Recuperación</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                <svg className="w-5 h-5 text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <button
                        type="button"
                        onClick={() => setStep(1)}
                        className="w-full bg-slate-800 hover:bg-slate-700 text-slate-400 hover:text-white font-bold py-3.5 rounded-xl transition-all duration-200 border border-white/5"
                    >
                        Volver
                    </button>
                </form>
